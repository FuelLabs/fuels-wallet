...
{/* <CodeImport file="../../../sdk/src/tests/Fuel.test.ts" testCase="currentAccount" /> */}
...
{/* <CodeImport file="../../../sdk/src/tests/Fuel.test.ts" testCase="sendTransaction" /> */}
...
{/* <CodeImport file="../../../sdk/src/tests/Fuel.test.ts" testCase="User getProvider on fuels-ts Wallet" /> */}

### Listing connectors

To list all available connectors you can use the `listConnectors(): Array<FuelWalletConnector>` method.

{/* <CodeImport file="../../../sdk/src/tests/FuelWalletConnectors.test.ts" testCase="listConnectors" /> */}

### Has connector

To check if a connector is on the connectors list use the `hasConnector(connectorName: string): boolean` method.

{/* <CodeImport file="../../../sdk/src/tests/FuelWalletConnectors.test.ts" testCase="hasConnector" /> */}
...
{/* <CodeImport file="../../../sdk/src/tests/FuelWalletConnectors.test.ts" testCase="selectConnector" /> */}
...
{/* <CodeImport file="../../../sdk/src/tests/FuelWalletConnectors.test.ts" testCase="addConnector" /> */}

### Remove connector

To remove a Wallet Connector use the `removeConnector(connectorName: string): boolean` method.

{/* <CodeImport file="../../../sdk/src/tests/FuelWalletConnectors.test.ts" testCase="removeConnector" /> */}
