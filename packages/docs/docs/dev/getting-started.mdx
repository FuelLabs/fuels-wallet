...
Please check out the [React Hooks](/docs/dev/react-hooks/) section to learn how to use them.

Otherwise, if you are working with other frameworks, you can use the typescript SDK directly as shown below.
