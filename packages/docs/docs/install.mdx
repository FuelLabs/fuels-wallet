...
- [Fuel Wallet](https://wallet.fuel.network/) - The official version on Chrome Store
- [Fuel Wallet Development](https://staging-wallet.fuel.network/) - The development version on Chrome Store
- [Fuel Wallet Next](https://next-wallet.fuel.network/) - Available only in zip format 