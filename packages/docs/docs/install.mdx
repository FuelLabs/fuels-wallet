...
Before starting using our SDK, you need first to install Fuel wallet browser extension.
Since we're already in an alpha version, it isn't possible to download directly from Chrome Extensions Store,
so you need to download the [FuelWallet zip file](https://wallet.fuel.network/app/fuel-wallet.zip) and import it directly into your extensions management page, on Chrome or Brave.
