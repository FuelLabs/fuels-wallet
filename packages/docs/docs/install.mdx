...
To install the next version of the Fuel Wallet, you have to:

- Download [FuelWallet zip file](https://next-wallet.fuel.network/app/fuel-wallet.zip);
...
{/* TO DO: remove this change before release the latest version on Chrome Web Store */}
