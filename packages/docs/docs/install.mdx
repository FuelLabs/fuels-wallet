...
After installing our browser extension, the wallet SDK will be injected automatically on the `window` object on the property `FuelWeb3`. To access it, you can use `window.FuelWeb3`.
