...
Return a FuelWalletLocked this class extends the fuels-ts SDK, WalletLocked,
enabling to execute any of the methods available, but using a FuelWalletProvider on the connection point,
...
Return a FuelWalletProvider this class extends fuels-ts SDK Provider, enabling to execute any of the methods available, but using FuelWallet on signature points, to request user permissions.
