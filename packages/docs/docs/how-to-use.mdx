...
To add a custom Asset, use the `wallet.addAsset` method and pass in the `Asset` you want to add.

<CodeImport file="../examples/AddAsset.tsx" />
...
To listen to assets events, you can use the `FuelWalletEvents.ASSETS` event.

<CodeImport file="../examples/events/Assets.tsx" lineStart="25" lineEnd="35" />
