...
To add custom Assets, use the `wallet.addAsset` method and pass in the `Asset | Asset[]` you want to add.
...
<CodeImport file="../examples/events/Assets.tsx" lineStart="24" lineEnd="34" />
